            ...
            <div class="card border-danger border-opacity-50 shadow-sm rounded-3">
              <div class="card-body p-4 d-flex justify-content-between align-items-center flex-wrap">
                <div>
                  ...
                  <p class="card-text text-muted small mb-0">Manually promote employees to Admin/HR status or revoke
                    administrative dashboard access.</p>
                </div>
                <a href="access_control.php" class="btn btn-danger px-4 py-2 small fw-medium mt-3 mt-md-0">Manage
                  Permissions</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="card h-100 border-success border-opacity-50 shadow-sm rounded-3">
              <div class="card-body p-4">
                ...
                <p class="card-text text-muted small mb-4">Audit your accurate file records, track designations, and
                  update
